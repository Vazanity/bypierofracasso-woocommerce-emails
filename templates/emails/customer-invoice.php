													...
													<tr>
														<td align="center" class="bg-FFFFFF block btn border-radius-4">
															<?php if ( $order->needs_payment() ) : ?>
																	<a href="<?php echo $order->get_checkout_payment_url(); ?>" class="font-primary font-4B7BEC font-14 font-weight-600 font-space-0-5 block btn white-space">
																	<?php printf(  __( $invoice_pending_btn , 'woocommerce' ) ); ?>
																	</a>
															<?php else : ?>
																	...
																	<?php printf(  __( $invoice_complete_btn , 'woocommerce' ) ); ?>
															<?php endif; ?>
														</td>
													</tr>
												</table>
									...
									<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="table-100pc">
										<tr>
											<td align="center" valign="middle" class="img-responsive">
												<img src="<?php echo $theme_path . "/" . $invoice_hero_bg_img ?>" border="0" width="600" alt="Header" class="block table-600">
											</td>
										</tr>
									</table>
									...
									<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="table-100pc">
										...
										<tr>
											<td align="left" valign="middle" class="center-text font-primary font-595959 font-16 font-weight-400 font-space-0 pb-20">
												<?php 
													printf( __( $additional_content . '<br><a class="font-4B7BEC" href="' . $order->get_checkout_payment_url() . '">' . 'Pay for this order', 'woocommerce' . '</a>' ) );
												?>
											</td>
										</tr>
										<?php else : ?>
												...
												<table border="0" align="center" cellpadding="0" cellspacing="0" >
													<tr>
														<td align="center" class="bg-4B7BEC block btn border-radius-4">
															<?php if ( $order->needs_payment() ) : ?>
																	<a href="<?php echo $order->get_checkout_payment_url(); ?>" class="font-primary font-FFFFFF font-14 font-weight-600 font-space-0-5 block btn white-space">
																	<?php printf(  __( $invoice_pending_btn , 'woocommerce' ) ); ?>
																	</a>
															<?php else : ?>
