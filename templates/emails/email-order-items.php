...
foreach ($items as $item_id => $item) :
    ...
    // Get the image URL, with a fallback to the placeholder if the product is invalid
    $image_url = (is_a($product, 'WC_Product') && $product->exists() && $product->get_image_id())
        ? current(wp_get_attachment_image_src($product->get_image_id(), 'medium'))
