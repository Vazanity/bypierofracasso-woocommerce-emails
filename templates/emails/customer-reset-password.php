<?php
/**
 * Customer Password Resetted Email
 *
									...
									<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="table-100pc">
										<tr>
											<td align="center" valign="middle" class="img-responsive">
												<img src="<?php echo $theme_path . "/" . $reset_password_hero_bg_img ?>" border="0" width="600" alt="Header" class="block table-600">
											</td>
										</tr>
									</table>
									...
									<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" class="table-100pc">
										...
										<tr>
											<td align="left" valign="middle" class="font-primary font-191919 font-18 font-weight-600 font-space-0 pb-20">
												<?php 
													...
													echo __( $reset_password_greeting . ' ' . $current_user->user_firstname . ',' );
												?>
											</td>
										</tr>
										...
										<tr>
											<td align="left" valign="middle" class="font-primary font-595959 font-16 font-weight-400 font-space-0 pb-40">
												...
												<?php printf(  __( $reset_password_link_text . '<br>' , 'woocommerce' ) ); ?>
												<a href="<?php echo esc_url( add_query_arg( array( 'key' => $reset_key, 'login' => rawurlencode( $user_login ) ), wc_get_endpoint_url( 'lost-password', '', wc_get_page_permalink( 'myaccount' ) ) ) ); ?>" class="font-4B7BEC">
													<?php printf(  __( $reset_password_link , 'woocommerce' ) ); ?>
												</a>
											</td>
										</tr>
												...
												<table border="0" align="center" cellpadding="0" cellspacing="0" >
													<tr>
														<td align="center" class="bg-4B7BEC block btn border-radius-4">
															<a href="<?php echo esc_url( add_query_arg( array( 'key' => $reset_key, 'login' => rawurlencode( $user_login ) ), wc_get_endpoint_url( 'lost-password', '', wc_get_page_permalink( 'myaccount' ) ) ) ); ?>" class="font-primary font-FFFFFF font-14 font-weight-600 font-space-0-5 block btn white-space">
															<?php printf(  __( $reset_password_btn, 'woocommerce' ) ); ?>
															</a>
														</td>
													</tr>
												</table>
...
<!-- Contents : Title Description Butto -->
