...
// ***********************************************//
$retunded_order_subtitle       = __( 'Your order refund status', 'bypierofracasso-woocommerce-emails' ); // Header SubTitle
$retunded_order_btn            = __( 'VIEW ORDER', 'bypierofracasso-woocommerce-emails' ); // Button
$retunded_order_hero_bg_img     = 'email-header-cust-refund.png'; // Header Icon Image File Name
$retunded_order_greeting        = __( 'Hello', 'bypierofracasso-woocommerce-emails' ); // Greeting Before User First Name
...
$top_offer_text                = __( 'Starto 30% OFF &rarr;', 'bypierofracasso-woocommerce-emails' );
